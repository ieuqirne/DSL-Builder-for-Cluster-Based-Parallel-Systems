...
public class dataGeneratorWithPrintOuts {
    static int numberClusters = 0;
    static int numberWorkers = 0;

    static ArrayList<String> ListImports = new ArrayList<>();
    static ArrayList<String> ListLibraries = new ArrayList<>();
    static ArrayList<String> ListEmitDetails = new ArrayList<>();
    static ArrayList<String> ListResultDetails = new ArrayList<>();
    static ArrayList<String> ListEmit = new ArrayList<>();
    static ArrayList<String> ListCol = new ArrayList<>();
    static ArrayList<String> ListBasicHost = new ArrayList<>();
    static ArrayList<String> ListBasicNode = new ArrayList<>();


    static ArrayList<String> ListImportsFile = new ArrayList<>();
    static ArrayList<String> ListNumbersNodeFile = new ArrayList<>();
    static ArrayList<String> ListInputsFile = new ArrayList<>();
    static ArrayList<String> ListOutputsFile = new ArrayList<>();
    static ArrayList<String> ListProDefFile = new ArrayList<>();
    static ArrayList<String> ListProManFile = new ArrayList<>();
    static ArrayList<String> defStringNames = new ArrayList<>();

    static String filePath = new File("").getAbsolutePath();
    static String tempOutPutfilePath = (filePath + "\\src\\main\\groovy\\cluster\\DataGenerator\\TemporaryFiles\\");
    static String outPutfilePath = (filePath + "\\src\\main\\groovy\\cluster\\DataGenerator\\Files\\");
    static String fNameFromScripts = "";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        createFileNumberNodes();

        createFileInputs();

        createFileOutputs();

        createFileProcessDefinition();

        createFileProcessManager();
    ...
    static void createFileNumberNodes(){

        try {
            FileWriter NumberNodesFileWriter = new FileWriter(tempOutPutfilePath + "NumberNodes.gpp");

            NumberNodesFileWriter.write("int nodes = " + numberClusters);
    ...
    static void createFileProcessDefinition(){
    ...
    static void createFileProcessManager(){
        try {
